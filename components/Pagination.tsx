...
const Pagination = () => {
  ...
  return (
    <div className="join flex justify-center py-16">
      <button
        className="join-item btn btn-lg bg-custom-dark-blue text-white hover:bg-white hover:text-blue-500"
        onClick={() => decrementPage()}
      >
        «
      </button>
      <button className="join-item btn btn-lg bg-custom-dark-blue text-white hover:bg-white hover:text-blue-500">
        Page {page}
      </button>
      <button
        className="join-item btn btn-lg bg-custom-dark-blue text-white hover:bg-white hover:text-blue-500"
