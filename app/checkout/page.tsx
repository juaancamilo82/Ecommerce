          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                className="w-full rounded-md border border-transparent bg-custom-dark-blue px-20 py-2 text-lg font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last"
              >
                Pay Now
              </button>
            </div>
