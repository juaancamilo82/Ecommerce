      ...
      />
        ...
        <div className="flex gap-x-2 max-sm:flex-col">
          <button
            ...
            className="uppercase bg-custom-dark-blue px-10 py-5 text-lg border border-black border-gray-300 font-bold text-white shadow-sm hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2"
          >
            Update product
          </button>
          <button
